...
import cn.TermslookupTest_1.ESHttpInfo;
...
//		ESHttpInfo esHttpInfo = new ESHttpInfo("192.168.220.149", 9200);
//		ESHttpInfo esHttpInfo = new ESHttpInfo("127.0.0.1", 9200);
        ESHttpInfo esHttpInfo = new ESHttpInfo("192.168.47.131", 9200);
//        ESHttpInfo esHttpInfo = new ESHttpInfo("192.168.221.174", 9200);
